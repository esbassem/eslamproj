...
export const PERMISSIONS = Object.freeze({
  ...
  PAPERWORK_ACCESS: 'paperwork.access',
  PAPERWORK_SEND: 'paperwork.send',
  PAPERWORK_RECEIVE: 'paperwork.receive',
  PAPERWORK_DELIVER: 'paperwork.deliver',
  PAPERWORK_CANCEL: 'paperwork.cancel',
  PAPERWORK_CORRECT: 'paperwork.correct',
  PAPERWORK_AUTHORIZE_RELEASE: 'paperwork.authorize_release',
