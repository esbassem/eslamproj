...
export const routeLoaders = {
  ...
  productAttributeValues: cached('productAttributeValues', () => import('@/features/products/pages/ProductAttributeValuesPage')),
  ...
  inventory: cached('inventory', () => import('@/features/inventory/pages/InventoryDashboard')),
...
export const appRouteRegistry = [
  ...
  { appCode: 'products', path: '/app/products', loader: routeLoaders.products },
  { appCode: 'inventory', path: '/app/inventory', loader: routeLoaders.inventory },
