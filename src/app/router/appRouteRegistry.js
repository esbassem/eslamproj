...
export const routeLoaders = {
  ...
  salesOverview: cached('salesOverview', () => import('@/features/sales/pages/SalesOverviewPage')),
  salesBranch: cached('salesBranch', () => import('@/features/sales/pages/SalesBranchPage')),
  saleCreate: cached('saleCreate', () => import('@/features/sales/pages/SaleCreatePage')),
  saleDetails: cached('saleDetails', () => import('@/features/sales/pages/SaleDetailsPage')),
...
export const appRouteRegistry = [
  ...
  { appCode: 'sales', path: '/app/sales', loader: routeLoaders.salesOverview },
  {
    appCode: 'accounting',
