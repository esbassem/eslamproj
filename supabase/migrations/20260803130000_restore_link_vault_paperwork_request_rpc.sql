...
begin
  ...
  perform pg_advisory_xact_lock(
    hashtextextended(p_tenant_id::text || ':vault-paperwork:' || p_sale_line_id::text, 0)
  );
...
revoke all on function public.link_vault_paperwork_request(
  uuid,
  uuid,
  uuid,
  uuid,
